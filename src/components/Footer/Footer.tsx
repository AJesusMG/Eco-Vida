  ...
  return (
    <footer className="footer items-center p-4 bg-neutral text-neutral-content">
      <aside className="items-center grid-flow-col">
        ...
        <p>Copyright © 2024 - Sec.Tec.Num#1 Xichotencalt Axayacatzin (Marbella Ceballos Fernández, Gael Martinez Soto, Julia Valeria Zendejas Rosales, Emilio Morales Flores)</p>
      </aside>
