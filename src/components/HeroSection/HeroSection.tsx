...
export default function HeroSection() {
  return (
    <div className="h-screen flex flex-col md:flex-row justify-between items-center px-8 gap-4">
      ...
      <div id="image" className="w-full md:w-3/6 flex justify-center md:justify-end">
        <Image
          src="/HeroImage.jpg"
